export class DateDiff {
  ...
  dateSeconds() {
    ...
    if (date1.getFullYear() >= date2.getFullYear()) {
      ...
      if((date1.getMonth() + 1 > date2.getMonth() + 1) && (date1.getFullYear() > date2.getFullYear())) {
        monthDiff = 12 + ((date.getMonth() + 1) - (date1.getMonth() + 1));
      } else if ((date1.getMonth() + 1 < date2.getMonth() + 1) && (date1.getFullYear() > date2.getFullYear())) {
